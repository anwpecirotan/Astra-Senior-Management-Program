...
public class ShareholderScoreHandler : MonoBehaviour
{
    ...
    public GameObject ForecastPeriodYear, changeable;
    ...
    private void AssignPeriodForecast()
    {
        ...
        for (int x = 1; x <= ValueDrivers.PlanningPeriod_Years; x++)
        {
            ...
            PeriodForecast.transform.localPosition = new Vector2(168 + 122 * x, 170);
