...
public class CountStandard : MonoBehaviour
{
    public class Operations
    {
        public class Sales
        {
            ...
            public static double ForecastPeriodYear1 = BaseFigures * (1 + (TemplateData.ValueDriver_SalesGrowthRate));
        ...
        {
            public static double BaseFigures = Sales.BaseFigures * TemplateData.ValueDriver_OperatingProfitMargin;
            public static double ForecastPeriodYear1 = Sales.ForecastPeriodYear1 * TemplateData.ValueDriver_OperatingProfitMargin;
        ...
        {
            public static double ForecastPeriodYear1 = OperatingProfitMargin.ForecastPeriodYear1 * TemplateData.ValueDriver_CashTaxRate;
    ...
    public class CapitalInvestments_FixedAssets
    {
        public class Balance
        {
            ...
            public static double ForecastPeriodYear1 = Operations.Sales.ForecastPeriodYear1 * TemplateData.ValueDriver_IncrementalFixedCapitalInvestment;
    ...
    public class NetWorkingCapitalInvestments
    {
        public class Balance
        {
            ...
            public static double ForecastPeriodYear1 = Operations.Sales.ForecastPeriodYear1 * TemplateData.ValueDriver_IncrementalWorkingCapitalInvestment;
    ...
    public class NetCashFlows_FreeCashFlows
    {
        ...
        {
            public static double BaseFigures = TemplateData.WACC_Baseline;
    ...
    void Start()
    {
        ...
        //AssignBaseText();
        NetCashFlows_FreeCashFlows.ContinuingValue.BaseFigures = TemplateData.WACC_Baseline;
        AssignFirstValue();
    ...
    private void AssignPeriodForecast()
    {
        ...
        for (int x = 1; x <= ValueDrivers.PlanningPeriod_Years; x++)
        {
            ...
            if (x < ValueDrivers.PlanningPeriod_Years)
            {
                FirstSales = (int)(FirstSales * (1 + (TemplateData.ValueDriver_SalesGrowthRate)));
                FirstOperatingProfit = (int)(FirstSales * TemplateData.ValueDriver_OperatingProfitMargin);
                ...
                FirstCIBalance = (int)(FirstSales * TemplateData.ValueDriver_IncrementalFixedCapitalInvestment);
                FirstCICashFlow = (int)(temp1 -FirstCIBalance);
                temp1 = FirstNWCBalance;
                FirstNWCBalance = (int)(FirstSales * TemplateData.ValueDriver_IncrementalWorkingCapitalInvestment);
        ...
        double CummulativePVofNetCashFlows = BaseCumulativeNCF;
        double PVofContinuingValue = NetCashFlows_FreeCashFlows.PVofContinuingValue.BaseFigures;
        ...
        BaseCumulativeNCF = ValueToShareholders - BookValueOfEquity;
    }
